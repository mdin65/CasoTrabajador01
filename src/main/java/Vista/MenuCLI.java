...
public class MenuCLI {
    ...
    // Método 1: Mostrar menú (Responsabilidad única: mostrar opciones)
    ...
    // Método 2: Obtener opción (Responsabilidad única: obtener entrada del usuario)
    ...
    // Método 3: Ejecutar opción (Responsabilidad única: ejecutar la acción seleccionada)
